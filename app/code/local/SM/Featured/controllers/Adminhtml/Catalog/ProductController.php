...
//require_once (Mage::getModuleDir('controllers','Mage_Adminhtml').DS.'ProductController.php');
class SM_Featured_Adminhtml_Catalog_ProductController extends Mage_Adminhtml_Controller_Action
{
    /**
